...
import { InputForm, TextArea, Alert } from "@/Components";
        ...
        <>
            <div className="mr-3 ml-3">
                <div className="font-bold text-lg font-raleway text-slate-400 mb-5">
                    <span className="text-base lg:text-lg flex justify-center lg:justify-start">
                        TUTORIAL SAMLING
                    </span>
                </div>
                <div className="">
                    <Accordion label="Cara Mendaftar Samsat Keliling">
                        <div>
                            <p className="text-slate-500 text-base">
                                1. Buka Aplikasi Samsat Keliling
                            </p>
                            <p className="text-slate-500 text-base">
                                2. Registrasi
                            </p>
                            ...
                            <p className="text-slate-500 text-base">
                                4. Masuk Ke Menu Pendaftaran dan Isi Semua
                                Formnya
                            </p>
                            <p className="text-slate-500 text-base">
                                5. Update Antrian Bisa Dilihat Di Halaman
                                Dashboard
                            </p>
                        </div>
                    </Accordion>
                    ...
                    <Accordion label="Cara Pembayaran">
                        <div>
                            <p className="text-slate-500 text-base">
                                {" "}
                                Setelah Samsat Selesai Pembayaran Bisa Dilakukan
                                Secara Cash Maupun Transfer Bank{" "}
                            </p>
                        </div>
                    </Accordion>
                </div>
            ...
            <div className="mr-3 ml-3">
                <div className=" bg-slate-50 shadow-lg rounded-tl-3xl rounded-br-3xl p-4 ml-2 mr-4">
                    <div className="text-slate-500 text-lg font-raleway font-bold mb-6 text-center">
                        INFORMASI{" "}
                        <span className="text-indigo-500 italic">SAMLING</span>
                    </div>
    ...
    return (
        <>
            ...
            <div className="flex justify-center ">
                <div className="w-[600px] rounded-tl-3xl rounded-br-3xl shadow-lg p-6 bg-gradient-to-r from-cyan-500 to-blue-500">
                    <div className="text-center text-white font-bold font-raleway text-xl mb-3">
                        Sign Up Wajib Pajak
                    </div>
                    <hr className="bg-white mb-3" />
                    <div>
                        <form onSubmit={submit} processing={processing}>
                            <div class="grid grid-cols-3 flex items-center mb-3">
                            ...
                            <div class="grid grid-cols-3 flex items-center mb-3">
                                ...
                                <div className="col-span-2">
                                    <InputForm
                                        ...
                                        type="text"
                                        onChange={(value) =>
                                            handleInputChange("no_tlp", value)
                                        }
                                        errors={errors.no_tlp}
                                    />
                                </div>
                            </div>
                            <div class="grid grid-cols-3 flex items-center mb-3">
                    ...
                    <div className="w-[60%] mt-3">
                        <div className="py-4 pl-4 flex items-center justify-between relative">
                            <div className="flex items-center">
                                <img
                                    src="/image/samsat_logo.png"
                                    alt="Your Image"
                                    className="h-[80px] w-[100px] ml-4 mr-5"
                                />
                                <span className="bg-gradient-to-r from-blue-700 via-indigo-950 to-indigo-400 text-transparent bg-clip-text text-xl font-bold font-raleway dark:via-white dark:to-indigo-400 hidden lg:block">
                                    Samsat Keliling
                                </span>
                            </div>
                        </div>
                            ...
                            <div className="mr-8 mb-8 mt-8 absolute lg:hidden z-50 bg-white">
                                <div className="w-[200px] h-[300px] rounded-md shadow-lg">
                                    <div className="pt-4 pl-4">
                                        <button
                                            className={`text-slate-400 py-2 px-2 rounded-md cursor-pointer font-bold ${
                                                roles === 1 &&
                                    ...
                                    <div className="flex justify-center pt-4 gap-2 mb-3">
                                        <div className="bg-slate-700 rounded-md hover:bg-slate-800">
                                            <button
                                                className="text-white py-3 px-2 rounded-md cursor-pointer"
                                                onClick={() => setRoles(4)}
                                            >
                                                Sign Up
                                            </button>
                        ...
                        <div className="mr-6 mt-3 ">
                            <div className=" py-4 pl-4 rounded-lg mb-[80px]">
                                <div className="flex justify-center gap-2">
                                    <div
                                        className={`text-slate-400 font-bold py-1 px-4 rounded-md font-raleway text-sm hover:bg-blue-400 hover:text-white ${
                                            roles === 1 &&
                                            "bg-blue-500 text-white"
                                        }`}
                                    >
                                        <button onClick={() => setRoles(1)}>
                                            BERANDA
                                        </button>
                                    </div>
                                    <div
                ...
                <div className="flex">
                    ...
                    <div className="w-full">
                        <div className="">
                            ...
                            {roles === 3 && <HubungiKami />}
                            {roles === 4 && <RegisterPage />}
                            {roles === 5 && (
                                <form onSubmit={submit}>
                                    <LoginPage processing={processing}>
                                        <div className="flex gap-2 items-center mb-3">
                                            <span className="text-white font-semibold mr-7">
                                                Email
                                            </span>
                                            <InputForm
                                                value={data.email}
